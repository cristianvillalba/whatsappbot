...
const port = process.env.BOTPRESS_PORT || process.env.PORT || 8081
const botUrl = isProd ? 'http://puppetbot-215415.appspot.com/' : 'http://localhost:' + port
